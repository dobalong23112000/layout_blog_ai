  ...
  return (
    <section className="max-w-7xl mx-auto py-8 grid grid-cols-1 md:grid-cols-12 gap-8">
      ...
      <aside className="md:col-span-3 space-y-4">
        <h2 className="text-xl font-semibold uppercase">Latest News</h2>
      ...
      {/* Hero Section */}
      <div className="md:col-span-6 relative overflow-hidden border ">
        <img
          src= "images/warning/5.jpg"
          alt="Hero"
          className="w-full h-64 md:h-74 object-cover"
        />
        <div className="sm:absolute relative bg-white px-6 py-3 flex flex-col justify-end">
          <span className="text-[11px] uppercase cursor-pointer mb-3 bg-blue-100 uppercase font-medium text-blue-600 bg-blue-50 px-2 py-1 rounded-full w-fit">FEATURED</span>
          <h1 className="text-2xl md:text-3xl font-bold hover:text-blue-600 cursor-pointer">
      ...
      <aside className="md:col-span-3 space-y-4">
        <h2 className="text-xl font-semibold uppercase">Trending</h2>
